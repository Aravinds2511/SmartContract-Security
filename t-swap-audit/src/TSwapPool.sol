...
contract TSwapPool is ERC20 {
    ...
    /*//////////////////////////////////////////////////////////////
                                 EVENTS
    //////////////////////////////////////////////////////////////*/
    //report-written: events missing indexing fields if ther are more than 3 params
    ...
    function deposit(
        ...
        uint256 minimumLiquidityTokensToMint,
        uint256 maximumPoolTokensToDeposit,
        // report-written - high deadline not used
        // there would be no limit on how long the transaction can take
        uint64 deadline
    )
        external
        ...
        returns (uint256 liquidityTokensToMint)
    {
        if (wethToDeposit < MINIMUM_WETH_LIQUIDITY) {
            // report-written : MINIMUM_WETH_LIQUIDITY is constant not req to be emitted
        ...
        if (totalLiquidityTokenSupply() > 0) {
            ...
            // @audit-gas : no need waste of gas
            ...
            // report-written : it would be better if this is before the ``_addLiquidityMintAndTransfer`` call - CEI
    ...
    function _addLiquidityMintAndTransfer(
        ...
        // report-written : this is backwards poolTokensToDeposit and wethToDeposit are interchanged in event
        ...
        returns (uint256 outputAmount)
    {
        ...
        // report-written: magic numbers should be constants
    ...
    {
        return
            // report-written : there is a math error 10000 should be 1000
    ...
    function swapExactInput(
        ...
        revertIfDeadlinePassed(deadline)
        returns (
            // report-written: need to return outputAmount
            uint256 output
        )
    {
        ...
        returns (uint256 inputAmount)
    {
        ...
        // report-written : need a max input amount to prevent slippage
        _swap(inputToken, inputAmount, outputToken, outputAmount);
    }
    ...
    function sellPoolTokens(
        ...
        return
            // report-written: for swapExactOutput, we need to pass in the amount of tokens to receive
            // should be swapExactInput
            swapExactOutput(
                i_poolToken,
                i_wethToken,
                poolTokenAmount,
    ...
    function _swap(
        ...
        // report-written: breaks the protocol invariant x.y = k
        swap_count++;
